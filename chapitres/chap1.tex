...
\begin{prop}\label{prop:terme-plongement}
...
\todo[inline]{satisfiable ou satisfaisable? le second sonne mieux non?}

\begin{rema}
Nous allons voir qu'une théorie est satisfiable si et seulement si elle est cohérente. L'implication directe repose sur le théorème de correction, énoncant que
...
\begin{coro}
T est cohérente si et seulement si T est satisfiable.
\end{coro}
\begin{proof}
Nous prouvons la contraposée. Supposons que T est insatisfiable, par définition il n'existe pas de modèles de T, donc pour $\phi$ une phrase quelconque,
$T \models (\phi \wedge \neg\phi)$ est trivialement verifié, et par théorème de complétude de Gödel, $T \vdash (\phi \wedge \neg\phi)$.
\end{proof}
...
nous prouvons la contraposée: supposons que $T$ est insatisfiable. D'après le corollaire précédent, $T$ est incohérente. Il existe donc $\sigma$ une preuve d'une contradiction à partir de $T$.
...
$T_0$ est insatisfiable.
\end{proof}

\section{Complétude d'une théorie}
\section{Categoricité et test de Vaught}


\todo[inline]{}\label{defi-completude}
\todo[inline]{}\label{lemm-sous-struct-sant-quant}
