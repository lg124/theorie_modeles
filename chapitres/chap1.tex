...
\begin{theo}\label{Equivalence et isomorphisme}
...
\begin{proof}
Nous commençons par montrer par induction sur les termes que pour $t$ un $\mathcal{L}$-terme, muni de variables libres dans $\overline{v} = (v_1,\dots,v_n)$,
et $\overline{a}=(a_1,\dots,a_n) \in M^n$, on a $j(t^{\mathcal{M}}(\overline{a}))
= t^{\mathcal{N}}(j(\overline{a}))$, en notant $j(\overline{a})=(j(a_1),\dots,j(a_n))$.
\end{proof}
...
\todo[inline]{reprendre cette preuve en adaptant les notations et en alignant tous les cas à gauche}
...
sous-ensemble $X \subseteq M^n$ est \kw{définissable} s'il existe une 
...
$\phi(\overline{v},\overline{b})$ \kw{définit} $X$. Soit $A \subseteq 
M$, on dit que $X$ est \kw{$A$-définissable}, ou \kw{définissable 
...
\begin{exem}
On se munit du langage des anneaux $\mathcal{L}_{ring} = \{0, 1, +, \cdot\}$ et de son modèle $\mathbb{C}$, le corps des nombres complexes.
...
\begin{align*}
\phi(z): \underbrace{z \cdot \dots \cdot z}_{n \text{ fois}} = 1
\end{align*}
...
\begin{proof}
Soit $\overline{a} \in A$ et $\psi(\overline{v}, \overline{a})$ la $\mathcal{L}$-formule définissant $X$.
Soient $\sigma$ un automorphisme de $\mathcal{M}$ tel que $\sigma(\overline{a}) = \overline{a}$ et $\overline{b} \in M^n$.
\end{proof}

Il est typique d'utiliser ce résulat pour sa contraposée, nous donnons un exemple.
