...
\noindent Nous présentons le résultat suivant comme fait algébrique. Il est le pillier pour distinguer des modèles de $\ACF_p$ de même cardinalité via des invariants.

\begin{theo}[Théorème de Steinitz]
Deux corps algébriquement clos sont isomorphes si et seulement s'ils ont même caractéristique et même degré de transcendance.
\end{theo}
...
degré de transcendance est aussi égal à $\kappa$. Ainsi deux modèles de $ACF_p$ de même cardinalité indénombrable sont isomorphespar Théorème de Steinitz.
\end{proof}
