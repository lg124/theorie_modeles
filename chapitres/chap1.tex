...
exemple ci dessous à placer après la def
...
intro sur theoreme de compacité comme pierre angulaire de la théorie des modèles
...
\end{theo}
construction de henkin en annexe
...
\label{lemm-sous-struct-sant-quant}
\label{prop-sous-struct-existance}